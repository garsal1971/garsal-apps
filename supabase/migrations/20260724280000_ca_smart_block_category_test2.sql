-- Nuovo giro di test del picker categorie (dopo la pulizia in 20260724270000): due transazioni
-- fittizie fresche + notifica Smart Block con il payload interattivo (transactions+categories
-- con parent_id, v1.3.7).
do $$
declare
  v_user_id      uuid;
  v_rule_id      uuid;
...
begin
  ...
  values (
    ...
    'TEST — categorizza 2 transazioni finte (giro 2)',
