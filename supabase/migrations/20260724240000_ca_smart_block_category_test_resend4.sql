-- Quarto rinvio della notifica di test (payload con parent_id per il picker raggruppato),
-- stessa logica delle precedenti: riusa le transazioni fittizie se ancora senza categoria.
do $$
declare
  v_user_id      uuid;
  v_rule_id      uuid;
...
begin
  ...
  values (
    ...
    'TEST — categorizza 2 transazioni finte (rinvio 4)',
