-- Secondo rinvio della notifica di test del picker categorie — stessa logica della migration
-- precedente (20260724210000): riusa le transazioni fittizie se ancora senza categoria,
-- altrimenti ne crea di nuove.
do $$
declare
  v_user_id      uuid;
  v_rule_id      uuid;
...
begin
  ...
  values (
    ...
    'TEST — categorizza 2 transazioni finte (rinvio 2)',
