-- Nuovo giro di test del picker categorie, ora con il filtro visible_in_app applicato
-- (v1.3.2/v1.3.3): due transazioni fittizie fresche + notifica Smart Block.
do $$
declare
  v_user_id      uuid;
  v_rule_id      uuid;
...
begin
  ...
  values (
    ...
    'TEST — categorizza 2 transazioni finte (giro 3, filtro visible_in_app)',
