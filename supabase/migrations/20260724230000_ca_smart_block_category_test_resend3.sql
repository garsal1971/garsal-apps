-- Terzo rinvio della notifica di test, con il payload aggiornato che include parent_id per
-- ogni categoria (necessario al nuovo picker Android con lista raggruppata principale/
-- sottocategorie + campo di ricerca, come in cost-analysis.html).
do $$
declare
  v_user_id      uuid;
  v_rule_id      uuid;
...
begin
  ...
  values (
    ...
    'TEST — categorizza 2 transazioni finte (rinvio 3, con sottocategorie)',
